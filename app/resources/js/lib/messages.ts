...
export const MESSAGES: Record<MessageCode, MessageEntry> = {
  ...
  MSG_08: {
    code: 'MSG-08',
    text: 'Verifique sua conexão de Internet.',
    type: 'error',
  },
  MSG_09: { code: 'MSG-09', text: 'Conta Desativada.', type: 'error' },
  MSG_10: {
    code: 'MSG-10',
    text: 'Aguarde 30 segundos e tente novamente.',
    type: 'warning',
  },
  MSG_11: {
    code: 'MSG-11',
    text: 'Um link de redefinição será enviado para o e-mail informado.',
    type: 'info',
  },
  ...
  MSG_14: {
    code: 'MSG-14',
    text: 'Informações da família atualizadas com sucesso.',
    type: 'success',
  },
  ...
  MSG_19: {
    code: 'MSG-19',
    text: 'Família desativada com sucesso.',
    type: 'success',
  },
}
