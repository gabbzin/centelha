  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="relative">
        {/* Drop area */}
        <div
          className="border-border has-[input:focus]:border-ring has-[input:focus]:ring-ring/50 data-[dragging=true]:bg-accent/50 relative flex min-h-24 flex-col items-center justify-center overflow-hidden rounded-xl border border-dashed p-1 transition-colors has-[input:focus]:ring-[3px]"
