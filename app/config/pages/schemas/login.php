    ...
    'sections' => [
        [
            ...
            'fields' => [
                ...
                ['key' => 'texts.password_placeholder', 'label' => 'Placeholder da senha', 'type' => 'string', 'max' => 30],
                ['key' => 'texts.remember_label', 'label' => 'Label "Lembrar de mim"', 'type' => 'string', 'max' => 30],
                ['key' => 'texts.forgot_link', 'label' => 'Link "Esqueceu a senha"', 'type' => 'string', 'max' => 40],
                ['key' => 'texts.submit_button', 'label' => 'Botão de entrar', 'type' => 'string', 'max' => 30],
            ],
        ],
    ],
];
