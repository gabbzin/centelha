...
return [
    ...
    | try and automatically detect it for you. Do note that enabling these
    | options will NOT automatically make SSR work, as a separate rendering
    | service needs to be available. To learn more, please visit
    ...
    */
    ...
    | page components exist on disk when rendering a page. This is useful for
